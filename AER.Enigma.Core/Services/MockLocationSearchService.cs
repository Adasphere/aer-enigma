...
namespace AER.Enigma.Core.Services
{
    ...
    /// </summary>
    public sealed class MockLocationSearchService : ILocationSearchService
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MockLocationSearchService"/> class.
        /// </summary>
        public MockLocationSearchService()
        {
            this.Initialize();
        }
